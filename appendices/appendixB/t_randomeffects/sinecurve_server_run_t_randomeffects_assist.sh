#!/bin/bash
# ---------------------------------------------------------------------------
# sinecurve_server_run_t_randomeffects_assist.sh
#
# Launches the sine-curve assist simulation with t-distributed random effects
# as NJOBS independent Rscript processes, one per detached `screen` session.
#
#   ./sinecurve_server_run_t_randomeffects_assist.sh              # NJOBS jobs, all of them
#   ./sinecurve_server_run_t_randomeffects_assist.sh 40           # 40 jobs, all of them
#   ./sinecurve_server_run_t_randomeffects_assist.sh 40 3 8 14    # 40 jobs, launch only 3, 8, 14
#
...
SCRIPT="sinecurve_server_simulation_t_randomeffects_assist.R"
PREFIX="sinecurve_t_randomeffects_assist"             # screen-session name prefix
