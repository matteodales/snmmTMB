#!/bin/bash
# ---------------------------------------------------------------------------
# sinecurve_server_run_t_randomeffects_snmmTMB.sh
#
# Launches the sine-curve snmmTMB simulation with t-distributed random effects
# as NJOBS independent Rscript processes, one per detached `screen` session.
#
#   ./sinecurve_server_run_t_randomeffects_snmmTMB.sh              # NJOBS jobs, all of them
#   ./sinecurve_server_run_t_randomeffects_snmmTMB.sh 40           # 40 jobs, all of them
#   ./sinecurve_server_run_t_randomeffects_snmmTMB.sh 40 3 8 14    # 40 jobs, launch only 3, 8, 14
#
...
#   Rscript sinecurve_server_simulation_t_randomeffects_snmmTMB.R <job> <njobs>
#
# Before launching, compile the TMB models in ../../../src/ once:
#   Rscript sinecurve_server_compile_t_randomeffects.R
# ---------------------------------------------------------------------------
...
SCRIPT="sinecurve_server_simulation_t_randomeffects_snmmTMB.R"
PREFIX="sinecurve_t_randomeffects_snmmTMB"            # screen-session name prefix
CPU_OFFSET=100                                        # job i is pinned to core CPU_OFFSET+i; the three
