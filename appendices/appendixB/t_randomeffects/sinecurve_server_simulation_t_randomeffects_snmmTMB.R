# ------------------------------------------------------------------------------
# sinecurve_server_simulation_t_randomeffects_snmmTMB.R
#
# snmmTMB script for the sine-curve simulation with t-distributed random effects
...
#
# with <job> in 1..<njobs>; sinecurve_server_run_t_randomeffects_snmmTMB.sh launches all of the jobs at once.
...
if (length(args) < 1) {
  stop("Usage: Rscript sinecurve_server_simulation_t_randomeffects_snmmTMB.R <job> [<njobs>]")
}
...
src_dir <- "../../../src"
results_dir <- "results"
output_prefix <- "sinecurve_server_t_randomeffects_snmmTMB"
save_every <- 1L
