#!/bin/bash
# ---------------------------------------------------------------------------
# sinecurve_server_run_t_residuals_assist.sh
#
# Launches the sine-curve assist simulation with t-distributed residuals as
# NJOBS independent Rscript processes, one per detached `screen` session.
#
#   ./sinecurve_server_run_t_residuals_assist.sh              # NJOBS jobs, all of them
#   ./sinecurve_server_run_t_residuals_assist.sh 40           # 40 jobs, all of them
#   ./sinecurve_server_run_t_residuals_assist.sh 40 3 8 14    # 40 jobs, launch only 3, 8, 14
#
...
#   Rscript sinecurve_server_simulation_t_residuals_assist.R <job> <njobs>
#
...
SCRIPT="sinecurve_server_simulation_t_residuals_assist.R"
PREFIX="sinecurve_t_residuals_assist"                 # screen-session name prefix
