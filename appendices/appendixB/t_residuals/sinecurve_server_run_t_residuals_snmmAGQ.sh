#!/bin/bash
# ---------------------------------------------------------------------------
# sinecurve_server_run_t_residuals_snmmAGQ.sh
#
# Launches the sine-curve snmmAGQ simulation with t-distributed residuals as
# NJOBS independent Rscript processes, one per detached `screen` session.
#
#   ./sinecurve_server_run_t_residuals_snmmAGQ.sh              # NJOBS jobs, all of them
#   ./sinecurve_server_run_t_residuals_snmmAGQ.sh 40           # 40 jobs, all of them
#   ./sinecurve_server_run_t_residuals_snmmAGQ.sh 40 3 8 14    # 40 jobs, launch only 3, 8, 14
#
# Run from this directory. Each job writes its own results/ and logs/ file;
# sinecurve_server_merge_and_plots_t_residuals.R merges the results afterwards.
#
...
#   Rscript sinecurve_server_simulation_t_residuals_snmmAGQ.R <job> <njobs>
#
...
SCRIPT="sinecurve_server_simulation_t_residuals_snmmAGQ.R"
PREFIX="sinecurve_t_residuals_snmmAGQ"                # screen-session name prefix
