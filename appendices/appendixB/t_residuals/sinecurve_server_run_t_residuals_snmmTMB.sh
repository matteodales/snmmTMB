#!/bin/bash
# ---------------------------------------------------------------------------
# sinecurve_server_run_t_residuals_snmmTMB.sh
#
# Launches the sine-curve snmmTMB simulation with t-distributed residuals as
# NJOBS independent Rscript processes, one per detached `screen` session.
#
#   ./sinecurve_server_run_t_residuals_snmmTMB.sh              # NJOBS jobs, all of them
#   ./sinecurve_server_run_t_residuals_snmmTMB.sh 40           # 40 jobs, all of them
#   ./sinecurve_server_run_t_residuals_snmmTMB.sh 40 3 8 14    # 40 jobs, launch only 3, 8, 14
#
...
#   Rscript sinecurve_server_compile_t_residuals.R
# ---------------------------------------------------------------------------
...
SCRIPT="sinecurve_server_simulation_t_residuals_snmmTMB.R"
PREFIX="sinecurve_t_residuals_snmmTMB"                # screen-session name prefix
