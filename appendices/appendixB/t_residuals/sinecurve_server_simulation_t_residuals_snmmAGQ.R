# ------------------------------------------------------------------------------
# sinecurve_server_simulation_t_residuals_snmmAGQ.R
#
# snmmAGQ script for the sine-curve simulation with t-distributed residuals of
...
#
# with <job> in 1..<njobs>; sinecurve_server_run_t_residuals_snmmAGQ.sh launches all of the jobs at once.
...
if (length(args) < 1) {
  stop("Usage: Rscript sinecurve_server_simulation_t_residuals_snmmAGQ.R <job> [<njobs>]")
}
...
src_dir <- "../../../src"
results_dir <- "results"
output_prefix <- "sinecurve_server_t_residuals_snmmAGQ"
