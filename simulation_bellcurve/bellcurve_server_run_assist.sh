#!/bin/bash
# ---------------------------------------------------------------------------
# bellcurve_server_run_assist.sh
#
# Launches the bell-curve assist simulation as NJOBS independent Rscript
# processes, one per detached `screen` session.
#
#   ./bellcurve_server_run_assist.sh               # NJOBS jobs, all of them
#   ./bellcurve_server_run_assist.sh 40            # 40 jobs, all of them
#   ./bellcurve_server_run_assist.sh 40 3 8 14     # 40 jobs, launch only 3, 8, 14
#
...
SCRIPT="bellcurve_server_simulation_assist.R"
PREFIX="bellcurve_assist"                             # screen-session name prefix
