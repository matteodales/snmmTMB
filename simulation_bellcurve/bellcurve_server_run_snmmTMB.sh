#!/bin/bash
# ---------------------------------------------------------------------------
# bellcurve_server_run_snmmTMB.sh
#
# Launches the bell-curve snmmTMB simulation as NJOBS independent Rscript
# processes, one per detached `screen` session.
#
#   ./bellcurve_server_run_snmmTMB.sh              # NJOBS jobs, all of them
#   ./bellcurve_server_run_snmmTMB.sh 40           # 40 jobs, all of them
#   ./bellcurve_server_run_snmmTMB.sh 40 3 8 14    # 40 jobs, launch only 3, 8, 14
#
...
#   Rscript bellcurve_server_compile.R
# ---------------------------------------------------------------------------
...
SCRIPT="bellcurve_server_simulation_snmmTMB.R"
PREFIX="bellcurve_snmmTMB"                            # screen-session name prefix
