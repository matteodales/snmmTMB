#!/bin/bash
# ---------------------------------------------------------------------------
# sinecurve_server_run_snmmAGQ.sh
#
# Launches the sine-curve snmmAGQ simulation as NJOBS independent Rscript
# processes, one per detached `screen` session.
#
#   ./sinecurve_server_run_snmmAGQ.sh              # NJOBS jobs, all of them
#   ./sinecurve_server_run_snmmAGQ.sh 40           # 40 jobs, all of them
#   ./sinecurve_server_run_snmmAGQ.sh 40 3 8 14    # 40 jobs, launch only 3, 8, 14
#
...
SCRIPT="sinecurve_server_simulation_snmmAGQ.R"
PREFIX="sinecurve_snmmAGQ"                            # screen-session name prefix
