#!/bin/bash
# ---------------------------------------------------------------------------
# sinecurve_server_run_snmmTMB.sh
#
# Launches the sine-curve snmmTMB simulation as NJOBS independent Rscript
# processes, one per detached `screen` session.
#
#   ./sinecurve_server_run_snmmTMB.sh              # NJOBS jobs, all of them
#   ./sinecurve_server_run_snmmTMB.sh 40           # 40 jobs, all of them
#   ./sinecurve_server_run_snmmTMB.sh 40 3 8 14    # 40 jobs, launch only 3, 8, 14
#
...
#   Rscript sinecurve_server_simulation_snmmTMB.R <job> <njobs>
#
...
SCRIPT="sinecurve_server_simulation_snmmTMB.R"
PREFIX="sinecurve_snmmTMB"                            # screen-session name prefix
