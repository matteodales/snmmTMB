# ------------------------------------------------------------------------------
# sinecurve_server_simulation_assist.R
#
# assist script for the sine-curve simulation of manuscript Section 3 (Figure 1)
#
...
#
# with <job> in 1..<njobs>; sinecurve_server_run_assist.sh launches all of the jobs at once.
...
if (length(args) < 1) {
  stop("Usage: Rscript sinecurve_server_simulation_assist.R <job> [<njobs>]")
}
...
results_dir <- "results"
output_prefix <- "sinecurve_server_assist"
